...
const projects = [
  {
    ...
    description:
      "A simple and secure video calling app to connect with friends or teams in real-time — no login needed.",
    image: "/ApnaVideoCall.png",
    tags: ["Next.js", "Node.js", "Express.js", "Socket.io", "Tailwind CSS", "WebRTC"],
    demoUrl: "https://apna-video-call-1-7ai2.onrender.com/",
    githubUrl: "",
    features: [
      "One-click private video rooms",
      "Real-time video & audio (WebRTC)",
      "Peer-to-peer connection (Socket.io)",
    ],
  },
  // {
